...
public let cardSwipeActionAnimationDuration: TimeInterval  = 0.8 //change speed for card animating to any direction
...
//                name: Notification.Name(rawValue: "BringKolodaViewToFront"),
//                object: nil,
//                userInfo:nil)
