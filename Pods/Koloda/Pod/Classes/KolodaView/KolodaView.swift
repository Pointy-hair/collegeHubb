...
private let defaultBackgroundCardsTopMargin: CGFloat = 7.0 //Original 4 - set y distance between card stacks
private let defaultBackgroundCardsScalePercent: CGFloat = 0.90 // Original 0.95 - set width of cards behind the main card
